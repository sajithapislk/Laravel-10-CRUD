...
@section('content')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/product') }}" method="post" id="addForm" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image_file" accept=".jpg,.jpeg,.png" class="form-control" required>
                        <span class="text-danger">
                            @error('image_file')
                                {{ $message }}
                            @enderror
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/product') }}" method="post" id="editForm" enctype="multipart/form-data">
                    @csrf
                    @method("PATCH")
                    <div class="modal-body">
                        <div class="form-group">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/product') }}" method="post" id="deleteForm">
                    @method('DELETE')
                    @csrf
                    <div class="modal-body">
                        <p class="mb-5">
    ...
    <script>
        $(document).ready(function() {
            $("table").on("click", ".delete-btn", function() {
                ...
                $('#deleteForm').attr('action', website + "/admin/product/" + id);
            });
            $("table").on("click", ".edit-btn", function() {
                var id = $(this).parents('tr').find("td:eq(0)").text();
                var name = $(this).parents('tr').find("td:eq(1)").text();
                $('#editForm').attr('action', website + "/admin/product/" + id);
